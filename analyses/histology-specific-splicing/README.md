...
The purpose of this module is to identify splicing signatures or unique splicing events within each histology
...
* `02-plot_histology-specific_splicing_events.R` takes result table from above and generates UpSetR plots for each splicing case
...
├── README.md
├── plots
│   ├── norm-uniq-hits-case.pdf
│   ├── norm-uniq-hits-inclusion-or-skipping.pdf
│   └── upsetR_histology-specific.pdf
├── results
