...
Filter for cluster 8

```{r}
cluster8_df <- metadata %>%
  dplyr::filter(cluster == "Cluster 8",
                !is.na(EFS_days)) %>%
...
c8_clk_tpm_kap_os <- survival_analysis(
  metadata  = cluster8_df %>% 
...
readr::write_rds(c8_clk_tpm_kap_os,
                 file.path(results_dir, "logrank_cluster8_OS_clk1_tpm_group.RDS"))

c8_clk_tpm_kap_efs <- survival_analysis(
  metadata  = cluster8_df %>% 
    dplyr::filter(!is.na(CLK1_TPM_group)),
  ind_var = "CLK1_TPM_group",
  test = "kap.meier",
...
readr::write_rds(c8_clk_tpm_kap_efs,
                 file.path(results_dir, "logrank_cluster8_EFS_clk1_tpm_group.RDS"))
```
...
```{r}
# Generate kaplan meier survival models for OS and EFS, and save outputs
c8_clk_psi_kap_os <- survival_analysis(
  metadata  = cluster8_df %>% 
...
readr::write_rds(c8_clk_psi_kap_os,
                 file.path(results_dir, "logrank_cluster8_OS_clk1_psi_group.RDS"))

c8_clk_psi_kap_efs <- survival_analysis(
  metadata  = cluster8_df %>% 
    dplyr::filter(!is.na(CLK1_PSI_group)),
  ind_var = "CLK1_PSI_group",
  test = "kap.meier",
...
readr::write_rds(c8_clk_psi_kap_efs,
                 file.path(results_dir, "logrank_cluster8_EFS_clk1_psi_group.RDS"))
```

Generate cluster 8 KM SI_group plots

```{r}
km_c8_clk_tpm_os_plot <- plotKM(model = c8_clk_tpm_kap_os,
                    variable = "CLK1_TPM_group",
                    combined = F, 
                    title = "Cluster 8, overall survival",
                    p_pos = "topright")

ggsave(file.path(plot_dir, "km_cluster8_OS_clk1_tpm_group.pdf"),
       km_c8_clk_tpm_os_plot,
       width = 8, height = 5, units = "in",
       device = "pdf")

km_c8_clk1_tpm_efs_plot <- plotKM(model = c8_clk_tpm_kap_efs,
                    variable = "CLK1_TPM_group",
                    combined = F, 
                    title = "Cluster 8, event-free survival",
                    p_pos = "topright")

ggsave(file.path(plot_dir, "km_cluster8_EFS_clk1_tpm_group.pdf"), 
       km_c8_clk1_tpm_efs_plot,
       width = 8, height = 5, units = "in",
       device = "pdf")

km_c8_clk1_psi_os_plot <- plotKM(model = c8_clk_psi_kap_os,
                    variable = "CLK1_PSI_group",
                    combined = F, 
                    title = "Cluster 8, overall survival",
                    p_pos = "topright")

ggsave(file.path(plot_dir, "km_cluster8_OS_clk1_psi_group.pdf"),
       km_c8_clk1_psi_os_plot,
       width = 8, height = 5, units = "in",
       device = "pdf")

km_c8_clk1_psi_efs_plot <- plotKM(model = c8_clk_psi_kap_efs,
                    variable = "CLK1_PSI_group",
                    combined = F, 
                    title = "Cluster 8, event-free survival",
                    p_pos = "topright")

ggsave(file.path(plot_dir, "km_cluster8_EFS_clk1_psi_group.pdf"), 
       km_c8_clk1_psi_efs_plot,
       width = 8, height = 5, units = "in",
       device = "pdf")
...
```{r}
add_model_c8_efs <- fit_save_model(cluster8_df %>% 
...
forest_c8_clk1_efs <- plotForest(readRDS(file.path(results_dir, "cox_EFS_additive_terms_subtype_cluster_clk1_tpm_group.RDS")))

ggsave(file.path(plot_dir, "forest_add_EFS_cluster8_histology_resection_clk1_tpm_group.pdf"),
       forest_c8_clk1_efs,
       width = 9, height = 4, units = "in",
       device = "pdf")

add_model_c8_os <- fit_save_model(cluster8_df %>% 
...
forest_c8_clk1_os <- plotForest(readRDS(file.path(results_dir, "cox_OS_additive_terms_subtype_cluster_clk1_tpm_group.RDS")))

ggsave(file.path(plot_dir, "forest_add_OS_cluster8_histology_resection_clk1_tpm_group.pdf"),
       forest_c8_clk1_os,
       width = 9, height = 4, units = "in",
       device = "pdf")
```
...
forest_c8_clk1_efs <- plotForest(readRDS(file.path(results_dir, "cox_EFS_additive_terms_subtype_cluster_clk1_psi_group.RDS")))

ggsave(file.path(plot_dir, "forest_add_EFS_cluster8_histology_resection_clk1_psi_group.pdf"),
       forest_c8_clk1_efs,
       width = 9, height = 4, units = "in",
       device = "pdf")
...
forest_c8_clk1_os <- plotForest(readRDS(file.path(results_dir, "cox_OS_additive_terms_subtype_cluster_clk1_psi_group.RDS")))

ggsave(file.path(plot_dir, "forest_add_OS_cluster8_histology_resection_clk1_psi_group.pdf"),
       forest_c8_clk1_os,
       width = 9, height = 4, units = "in",
       device = "pdf")
```
...
forest_c8_clk1_efs <- plotForest(readRDS(file.path(results_dir, "cox_EFS_additive_terms_subtype_cluster_clk1_tpm.RDS")))

ggsave(file.path(plot_dir, "forest_add_EFS_cluster8_histology_resection_clk1_tpm.pdf"),
       forest_c8_clk1_efs,
       width = 9, height = 4, units = "in",
       device = "pdf")
...
forest_c8_clk1_os <- plotForest(readRDS(file.path(results_dir, "cox_OS_additive_terms_subtype_cluster_clk1_tpm.RDS")))

ggsave(file.path(plot_dir, "forest_add_OS_cluster8_histology_resection_clk1_tpm.pdf"),
       forest_c8_clk1_os,
       width = 9, height = 4, units = "in",
       device = "pdf")
```
...
forest_c8_clk1_efs <- plotForest(readRDS(file.path(results_dir, "cox_EFS_additive_terms_subtype_cluster_clk1_psi.RDS")))

ggsave(file.path(plot_dir, "forest_add_EFS_cluster8_histology_resection_clk1_psi.pdf"),
       forest_c8_clk1_efs,
       width = 9, height = 4, units = "in",
       device = "pdf")
...
forest_c8_clk1_os <- plotForest(readRDS(file.path(results_dir, "cox_OS_additive_terms_subtype_cluster_clk1_psi.RDS")))

ggsave(file.path(plot_dir, "forest_add_OS_cluster8_histology_resection_clk1_psi.pdf"),
       forest_c8_clk1_os,
       width = 9, height = 4, units = "in",
       device = "pdf")
```
