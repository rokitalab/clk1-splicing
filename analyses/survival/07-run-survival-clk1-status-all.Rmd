...
for (group in groups){
  ...
  coxph_os_model_file <- ifelse(group == "Low-grade glioma",
                             ...
                             file.path(results_dir,
                                       glue::glue("cox_{plot_names[group]}_OS_additive_terms_resection_clk1_group.RDS"))
  )
  ...
  coxph_efs_model_file <- ifelse(group == "Low-grade glioma",
                             ...
                             file.path(results_dir,
                                       glue::glue("cox_{plot_names[group]}_EFS_additive_terms_resection_clk1_group.RDS"))
  )
  ...
  add_model_os <- suppressWarnings(fit_save_model(group_hist,
                                  terms = ifelse(
                                      ...
                                      ifelse(group == "Mixed neuronal-glial tumor",
                                             "extent_of_tumor_resection+clk1_group+age_at_diagnosis_days+age_at_diagnosis_days",
                                              "clk1_group+age_at_diagnosis_days"
                                  )),
             coxph_os_model_file,
             "multivariate",
             years_col = "OS_years",
  ...
  add_model_efs <- suppressWarnings(fit_save_model(group_hist,
                                  terms = ifelse(
                                      ...
                                      ifelse(group == "Mixed neuronal-glial tumor",
                                             "extent_of_tumor_resection+clk1_group+age_at_diagnosis_days",
                                              "clk1_group+age_at_diagnosis_days"
                                  )),
...
for (i in 1:nrow(subtype_df)) {
  ...
  coxph_os_model_file <- ifelse(subtype_df$hist[i] == "Low-grade glioma",
                             file.path(results_dir,
                                      glue::glue("cox_{subtype_df$names[i]}_{subtype_df$subtype_name[i]}_OS_additive_terms_subtype_resection_clk1_group.RDS")),
                             file.path(results_dir,
  ...
  coxph_efs_model_file <- ifelse(subtype_df$hist[i] == "Low-grade glioma",
                             file.path(results_dir,
                                       glue::glue("cox_{subtype_df$names[i]}_{subtype_df$subtype_name[i]}_EFS_additive_terms_subtype_resection_clk1_group.RDS")),
                             file.path(results_dir,
